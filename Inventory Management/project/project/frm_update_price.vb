...
Public Class frm_update_price
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            Dim k As Integer
            ob.mycommand = New OleDbCommand("Update itemmaster set price = '" & TextBox4.Text & "' where icode = '" + Label6.Text + "'", ob.myconnection)
            k = ob.mycommand.ExecuteNonQuery()
            If k > 0 Then
                MessageBox.Show("Price updated successfully", "Successfull", MessageBoxButtons.OK, MessageBoxIcon.Information)
                TextBox1.Text = ""
                TextBox2.Text = ""
                TextBox3.Text = ""
                TextBox4.Text = ""
